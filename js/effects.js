...
function startUkbe() {
    ...
    if (!getEl('ukbe-tnt')) {
        tntEl = document.createElement('img'); tntEl.id = 'ukbe-tnt'; tntEl.src = url('assets/img/mod_gorselleri/tnt.png');
...
function spawnArrow() {
    ...
    const aEl = document.createElement('img'); aEl.src = url('assets/img/mod_gorselleri/ok.png'); aEl.className = 'ukbe-arrow';
